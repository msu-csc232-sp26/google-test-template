...
template class csc232::plain_box< std::string >;

#if TEST_TASK_3
#include "safe_deposit_box.cpp"
template class csc232::safe_deposit_box< std::string >;
template class csc232::plain_box< int >;
template class csc232::safe_deposit_box< int >;
#endif
